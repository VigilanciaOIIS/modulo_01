<html>
<head>
<title>Autoevaluación: Unidad 3</title>
</head>
<body>
...
<p>Elige la respuesta correcta</p>
  <div id='block-11'>
    <label for='option-11'>
      ...
      A. Una TBC activa coexistente puede predisponer a enfermedad COVID-19 grave</label>
    <span id='result-11'></span>
  </div>
   <div id='block-12'>
    <label for='option-12'>
      <input type='radio' name='option' value='B' id='option-12'/>
      B. El diagnóstico de COVID-19 en un paciente con TB no debe ser causa de interrupción del tratamiento</label>
    <span id='result-12'></span>
  </div>
   <div id='block-13'>
    <label for='option-13'>
      <input type='radio' name='option' value='C' id='option-13'/>
      C. El resfrío común tiene tres picos anuales: a inicios de otoño, a mediados de invierno y en primavera</label>
    <span id='result-13'></span>
  </div>
  <div id='block-14'>
    <label for='option-14'>
      <input type='radio' name='option' value='D' id='option-14'/>
      D. Todas son correctas</label>
    <span id='result-14'></span>
  </div>
  <div id='block-15'>
    <label for='option-15'>
      <input type='radio' name='option' value='E' id='option-15'/>
      E. Los síntomas más comunes de COVID-19 son fiebre, tos seca y cansancio</label>
...
<script>
  ...
  function displayAnswer1() {
    ...
    if (document.getElementById('option-14').checked) {
      ...
      document.getElementById('result-14').innerHTML = '¡Correcto! &#128175; Todos los enunciados son correctos. &#127775;'
      document.getElementById('block-11').style.border = 'initial';
      document.getElementById('result-11').style.color = 'initial';
      document.getElementById('result-11').innerHTML = '';
      document.getElementById('block-12').style.border = 'initial';
...
<div>
<h3>¿Cuál de los siguientes no es parámetro del CURB-65?</h3>
<p>Elige la respuesta correcta</p>
  <div id='block-21'>
    <label for='option-21'>
...
<script>
  ...
  function displayAnswer2() {
    ...
    if (document.getElementById('option-23').checked) {
      ...
      document.getElementById('result-23').innerHTML = '¡Correcto! &#128175; Para CURB-65, el parámetro de riesgo es frecuencia respiratoria mayor a 30 rpm. &#127775;'
      document.getElementById('block-21').style.border = 'initial';
      document.getElementById('result-21').style.color = 'initial';
      document.getElementById('result-21').innerHTML = '';
      document.getElementById('block-22').style.border = 'initial';
